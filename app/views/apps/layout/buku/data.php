...
<tr>
    ...
    <td class="text-center">
        ...
        <a onclick="return confirm('are you sure?')" class="badge badge-danger" style="background-color: #842020;" data-toggle="tooltip" data-placement="top" title="Delete ?" href="<?php echo base_url() ?>apps/buku/delete/<?php echo $this->encryption->encode($hasil->kode_buku) ?>"   onclick="return confirm('Anda Yakin Ingin Menghapus?');"><i class="fa fa-trash"></i> Delete</a>
    </td>
</tr>
<?php
endforeach;
