...
<tr>
    ...
    <th class="text-center" style="color: #000;"><i class="fa fa-book"></i> KODE BUKU</th>
...
foreach ($data_pinjam->result() as $hasil):
    ...
    <tr>
        ...
        <td class="text-center"> <?php echo $hasil->nama_anggota ?></td>
        <td class="text-center"> <?php echo $hasil->buku_kode ?></td>
