...
<body>
<div class="logo" style="margin-top: 100px"><img src="<?php echo $base_url = load_class('Config')->config['base_url']; ?>resources/public/images/logo-jombang.png" style="width: 230px"></div>
<div id="container">
